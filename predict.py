...
def main():
    ...
    img_amp_path = 'data/predict/6_pre_fog_amp.npy'
    img_phase_path = 'data/predict/6_pre_fog_phase.npy'
    ...
    img_amp = np.where(img_amp == 0, 0.001, img_amp)
    ...
    dist = reScale(dist, DistanceScale)
    plt.jet()
    plt.imshow(dist)
    plt.show()
